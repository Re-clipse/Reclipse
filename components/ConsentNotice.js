...
// honest one-line notice about the one thing we DO store (your login session,
// in localStorage), not a fake "accept all / reject all" vendor-toggle wall
// that would imply tracking we don't actually do.
  ...
  return (
    <div className="consent-banner" role="region" aria-label="Cookie and storage notice">
      <p>
        ...
        and remembers your theme — nothing else. <a href="/cookies">Learn more</a>
      </p>
