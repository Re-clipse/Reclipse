...
/** Open Stripe's billing portal so a Reclipse Plus subscriber can cancel or update their card. */
export async function POST(request) {
  ...
  const { data: sub } = await supabaseAdmin().from('premium_subscriptions')
  ...
  try {
    ...
    console.error('premium portal error:', err);
