    ...
    <main className="page page--narrow">
          ...
          <div className={`flip${revealed ? ' flip--revealed' : ''}`}>
            <div className="flip__inner" onClick={() => { setRevealed((r) => !r); play('flip'); }} role="button" tabIndex={0}>
              <div className="flip__face">
                ...
                <span className="flip__cue">Answer out loud first &mdash; then flip</span>
              </div>
      ...
      {stage === 'done' && (
        <div className="card center animate-in" style={{ padding: 'var(--s-7)' }}>
          ...
          <h2 style={{ fontSize: 'var(--text-2xl)' }}>That&apos;s the whole loop</h2>
          ...
          <p className="muted" style={{ marginTop: 'var(--s-2)' }}>
            Flip, recall, quiz, repeat &mdash; except with your own lecture notes, and with
