      ...
      <header className="lp-hero">
        ...
        <div className="lp-hero__inner">
          <div className="lp-hero__copy">
            <span className="badge rise">Now in early access · Wilfrid Laurier</span>
          ...
          <div className="lp-hero__art">
            <Mascot mood="wave" size={220} float />
          </div>
        </div>
      </header>
      ...
      <section className="section">
        <div className="section__inner">
          ...
          <div className="lp-steps">
            {[
              ['01', 'Upload', 'Drop in a PDF, snap a photo of your notes, or paste text.', '#EDE9FE'],
              ['02', 'We build it', 'Flashcards, fill-in-the-blanks and a quiz — from your material.', '#FEF3C7'],
              ['03', 'Recall', 'Answers stay hidden until you commit. That\u2019s what makes it stick.', '#DCFCE7'],
            ].map(([n, title, body, bg]) => (
              <div key={n} className="lp-step rise">
                <div className="lp-step__num" style={{ background: bg }}>{n}</div>
                <h3>{title}</h3>
                <p>{body}</p>
              </div>
            ))}
      ...
      <section className="section section--tint">
        <div className="section__inner">
          ...
          <div className="lp-features">
            {[
              [<><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/></>, 'Spaced repetition', 'Miss a card and it comes back sooner. Nail it and it fades. You review exactly what needs it.'],
              ...
              [<><rect x="3" y="3" width="18" height="18" rx="2"/><path d="m9 12 2 2 4-4"/></>, 'Photo to flashcards', 'Snap handwritten notes or a whiteboard — we read them and build cards.'],
              ...
              [<><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></>, 'Exam reminders', 'Upload your syllabus and we\u2019ll email you before each exam, quiz and lab.'],
            ].map(([icon, title, body]) => (
      ...
      <section className="section">
        <div className="section__inner lp-science">
          <div className="lp-science__art">
            <Mascot mood="thinking" size={160} float />
          </div>
          <div className="lp-science__copy">
            <span className="badge">The science</span>
            <h2>Rereading feels productive. It mostly isn&apos;t.</h2>
            <p>
      ...
      <section className="section">
        <div className="cta-band">
          ...
          <a href={signedIn ? '/upload' : '/login?mode=signup'} className="btn btn--accent btn--lg">
            {signedIn ? 'Create a study set' : 'Get started free'}
          </a>
        </div>
      </section>
    </>
